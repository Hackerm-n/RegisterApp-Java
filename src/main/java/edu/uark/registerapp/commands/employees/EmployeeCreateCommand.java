...
public class EmployeeCreateCommand implements ResultCommandInterface<Employee> {
	...
	public Employee execute() throws UnsupportedEncodingException, NoSuchAlgorithmException {
		...
		final EmployeeEntity createdEmployeeEntity = this.creaEmployeeEntity();
	...
	@Transactional
	private EmployeeEntity creaEmployeeEntity() throws UnsupportedEncodingException, NoSuchAlgorithmException {
